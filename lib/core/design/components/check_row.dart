...
/// color alone. `FlowTappable`'s `checked` (not `selected`) is the
/// correct trait for a checkbox-shaped control — a screen reader
/// announces "checked"/"unchecked" rather than "selected".
